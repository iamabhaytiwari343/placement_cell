...
const Toolbar = props => (
  <header className="toolbar text-light bg-dark">
    <nav className="toolbar_navigation">
      <div>
        <ToggleButton click={props.sideDrawerToggler} />
      </div>
      <Link to="/" style={{ textDecoration: "none", color: "white" }}>
        <div className="logo">BIT Placement Cell</div>
      </Link>
      <div className="spacer" />
      <div className="nav-elements"><NavLink to="/Login" exact className="activeclass">
        Login
      </NavLink></div>
