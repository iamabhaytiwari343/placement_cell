...
const Facilities = props => (
  <div className="procedure-outer">
    <div className="procedure-wrapper">
      <h1>Facilities</h1>
      <p>
        The campus of BIT MESRA DEOGHAR is situated at the outskirts of Temple city Deoghar providing fast connectivity to railway and airport situated at a distance less than a kilometers.
      </p>
