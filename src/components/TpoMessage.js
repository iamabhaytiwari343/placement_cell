...
const Messaget = props => (
    <div>
        ...
        <p className='msgp'>The Training and Placement cell of BITD is an integral part of the academics It helps in shaping the careers of our students in the field of Information Technology. </p><br />
        ...
        <br /><p className='cred' >Dr Vikash sharma</p>
        <p className='cred' style={{ marginBottom: '2vw' }}>Training and Placement Officer,BITD</p>
    </div>
)
