  ...
  <div className="procedure-outer">
    <div className="procedure-wrapper">
      ...
      <ul className="custom-list">
        <li>
          The Training and Placement Office, BITD sends invitations alongwith
        ...
        <li>
          ...
          sent by email to Training and Placement Office, BITD (
          <a href="mailto:infobitdeoghar@bitmesra.ac.in">infobitdeoghar@bitmesra.ac.in</a>
          ).
        </li>
        <li>
        ...
        <li>
          Training and Placement Office, BITD allots date(s) to an organization
          for campus placements. The organization confirms the date(s) to
          Training and Placement Office, BITD.
        </li>
        <li>
        ...
        <li>
          Training and Placement Office, BITD also coordinates the signing of
