  ...
  return (
    <div className="whyus-o-container">
      <div className="whyus-container">
        <h1 className="whyus-h1">Why Recruit at BITD?</h1>
        <p>
          <strong>BIT MESRA, Deoghar</strong> encourages its students to balance
        ...
        <p>
          ...
          All regular faculty members of the BITD, hold Ph.D. and have
