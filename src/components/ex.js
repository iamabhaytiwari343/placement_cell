...
import tpo from "../assets/images/tpo.jfif";
import director from "../assets/images/rcjha.jfif";
...
const Ex = props => (
  <div className="example">
    <div className="blog-card">
      <div className="meta">
        ...
        <ul className="details">
          <li className="author">Dr. R C Jha</li>
      ...
      <div className="description">
        ...
        <p>
          ...
          BIT Deoghar, which started its journey in 2007, has brought in the
    ...
    <div className="blog-card alt">
      <div className="meta">
        <div className="photo" style={{ backgroundImage: `url(${tpo})` }} />
        <ul className="details">
          <li className="author">Dr. Vikash sharma</li>
      ...
      <div className="description">
        ...
        <p>
          The Training and Placement cell of Birla Institute Of Technology is an integral part of the academics It helps in
